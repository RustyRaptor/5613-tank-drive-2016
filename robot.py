...
class MyRobot(wpilib.IterativeRobot):
    ...
    def teleopPeriodic(self):
        ...
        #                        self.stick1.getX())
        # self.drive.tankDrive((self.stick1.getY() * self.DriveSpd) * self.Direction,
        #                      self.stick2.getY() * self.DriveSpd * self.Direction)
        self.drive.tankDrive((self.stick1.getY() * self.DriveSpd),
                             self.stick2.getY() * self.DriveSpd)
